...
-(void)searchRepositoriesWithQuery:(NSString *)query Completion:(void (^) (BOOL success))completionBlock {
    
    [FISGithubAPIClient searchRepositoriesWithQuery:query Completion:^(NSArray *repoDictionaries) {
